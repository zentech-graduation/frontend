...
### Fixed
- An account's own profile no longer shows a stale post count after creating, archiving, or deleting a post; the cached profile is now invalidated the same way every other affected view already was.
