...
There is no `skill-workspace` in this repository; an earlier revision of this file referred to one. The skills that do exist are under `.agents/skills/`: `frontend-design`, `shadcn`, `ui-ux-pro-max`, `vercel-react-best-practices`, `web-design-guidelines`.
