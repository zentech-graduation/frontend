    ...
    categories: [
      {
        ...
        label: 'profile',
        hint: 'your name, picture and bio',
      },
      {
        id: 'notifications',
        path: ROUTES.SETTINGS_NOTIFICATIONS,
        label: 'notifications',
        hint: 'what luvax tells you about',
      },
      {
        id: 'saved',
        path: ROUTES.SAVED,
        label: 'saved posts',
        hint: 'the posts you kept',
    ...
    categories: [
      {
        ...
        label: 'privacy',
        hint: 'who can reach you and see you',
      },
      {
        id: 'requests',
        path: ROUTES.SETTINGS_REQUESTS,
        label: 'follow requests',
        hint: 'people waiting to follow you',
      },
      {
        id: 'blocked',
    ...
    categories: [
      {
        ...
        label: 'account',
        hint: 'your email, standing and password',
      },
    ],
  },
];
