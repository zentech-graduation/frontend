...
const ICONS = {
  ...
  alert: (
    <>
      ...
      <line x1="12" y1="7.4" x2="12" y2="13.2" />
...
const ICONS_FILLED = {
  home: (
    <>
      ...
      <rect x="9" y="13" width="6" height="9" rx="1" fill="var(--lx-base)" stroke="none" />
    </>
  ),
  explore: (
    <>
  ...
  profile: (
    <>
      ...
      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" fill="currentColor" stroke="none" />
    </>
  ),
  heart: (
    <path
